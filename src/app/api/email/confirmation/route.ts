  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9fafb;padding:32px 16px;">
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.06);">
        ...
        <!-- Header amarillo -->
        <tr>
          <td style="background:#FDC423;padding:28px 32px;text-align:center;">
            <img src="https://rasmalxjusrwpwbtoavs.supabase.co/storage/v1/object/public/images/brand/logo-transparent.png" alt="Doggo" width="80" height="80" style="border-radius:50%;display:block;margin:0 auto 12px;" />
