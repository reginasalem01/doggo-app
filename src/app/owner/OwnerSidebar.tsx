...
export default function OwnerSidebar() {
  ...
  return (
    <aside className="w-56 shrink-0 h-screen bg-doggo-dark2 border-r border-doggo-dark3 flex flex-col overflow-hidden">
      {/* Logo */}
      <div className="px-5 py-5 border-b border-doggo-dark3">
        <p className="text-white text-xl font-black tracking-tight">🌭 Doggo</p>
        <p className="text-doggo-yellow text-xs font-bold mt-0.5">Owner Panel</p>
      </div>
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-2.5 mx-2 rounded-xl text-sm font-semibold transition-colors ${
                active
                  ...
                  : 'text-gray-400 hover:text-white hover:bg-doggo-dark3'
              }`}
            >
      ...
      {/* Logout */}
      <div className="px-4 py-4 border-t border-doggo-dark3">
        <button
